...
import 'package:car_service/helper/localization/app_translations.dart';
import 'package:car_service/helper/theme.dart';
import 'package:car_service/model/language_model.dart';
...
class DisplayText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var textStyle = languageModel.isEng
        ...
        : const TextStyle(color: Colors.black, fontFamily: "Pyidaungsu");
